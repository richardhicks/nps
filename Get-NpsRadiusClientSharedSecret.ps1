...
.EXAMPLE
    .\Get-RadiusSharedSecrets.ps1 -FilePath C:\Backup\nps.xml

.DESCRIPTION
    Administrators can run Get-NpsRadiusClient to view the shared secret for all configured RADIUS clients on the NPS server. However, RADIUS shared secrets are also stored in plain text in the NPS configuration export file. This script reads the NPS configuration export XML file and extracts the shared secrets for all RADIUS clients.

.LINK
    https://github.com/richardhicks/nps/Get-NpsRadiusClientSharedSecret.ps1
...
# Read XML configuration export file
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAUUSv/6+jhqtGv
# 8PkFWQHrTvYtnGg0ZljwdUu78WXBZ6CCGpkwggNZMIIC36ADAgECAhAPuKdAuRWN
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg2PGZx3SzaE1hvF3JozsW9gbw
# G+0+hF5Ka3W0j75KECYwCwYHKoZIzj0CAQUABEgwRgIhAJClVRmzNntos6Pz2KsL
# PHe4GXfjf1DI9y/SfrbaexOcAiEA37z2A/HjPPFtyfeFSUP1pNNXBuDHaun76Nht
# pW3P7bihggMmMIIDIgYJKoZIhvcNAQkGMYIDEzCCAw8CAQEwfTBpMQswCQYDVQQG
# EwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xQTA/BgNVBAMTOERpZ2lDZXJ0
# IFRydXN0ZWQgRzQgVGltZVN0YW1waW5nIFJTQTQwOTYgU0hBMjU2IDIwMjUgQ0Ex
# AhAKgO8YS43xBYLRxHanlXRoMA0GCWCGSAFlAwQCAQUAoGkwGAYJKoZIhvcNAQkD
# MQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjUwNjEwMjM0OTU3WjAvBgkq
# hkiG9w0BCQQxIgQgk7bsdgwFeSX5YtZelQhlQo7Y/J9RGNrUnAgZAmg14lwwDQYJ
# KoZIhvcNAQEBBQAEggIAg/L/Qs6dHcx9PPbOG0XKwZzXiMXQSU1ilieHm+B0mQmE
# vXHHJpKPKfVw69567dmGNE2W0yUwRp8SxV2PH2LVzByovFpTC5PW9AL1buqmhSGH
# iZVQ1DF3dcJNOGmqqzo4mIFHqWWJl6vAQHt3r8xRcT0/6kw5V5MVh14cG+4SDDRs
# FPevjwjmvnqqnIF3qIOwU4+hXw/tq0i2Tn/GO8lmeS+uRW7W2o8r2rrjUQeqwgYx
# nTZ57Bns2tk9RpWfCS9RPoLpzEVySlVcQ2RyanDrdRgdDeOt8ztyvSWeNWmuDvky
# brrahCdcHmcXDgVv5Veq+YBqX4bzpwUM8VzikjrEJjB1fUwwvqnGRsJ9thmL7Z0i
# yQvlixUW0oFY0UzMeWlPfJKWPH29PwKsvAZ5WveDZM1GMdBTZ7sFKYJvmt7DJRSn
# s0wh2cudqCut5OsUgnXY/iE+jiIylmhRuw+/6GBikPHXyz4fcXYHwseYbuhi7yI+
# /ERsoPknF9IhnmghcFRk68rd/IIzfI+VdVkY3ivhIbwE+FTM3Ndz2N+m9FHwZTkT
# 2rvQEPIcK5tCQQhydZ1TO6fw0o9R7Drw3wZPQH3qveNh+wUy1ZjY5NE/amx3CuCT
# QFb9beJWN2sPf/zXf3ue9e0rDBUQyJ3Q+K6p54I5z02gHWkhDWwijJEdLL/YjK4=
